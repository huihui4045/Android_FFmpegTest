...
Java_android_1ffmpegtest_android_1ffmpegtest_Mp42YuvActivity_open(JNIEnv *env, jobject instance,
                                                                  jstring inputStr_,
                                                                  jstring outStr_) {
...
Java_android_1ffmpegtest_android_1ffmpegtest_VideoView_render(JNIEnv *env, jobject instance,
    ...
    const char *inputStr = env->GetStringUTFChars(input_, false);


}

JNIEXPORT jstring JNICALL
Java_android_1ffmpegtest_android_1ffmpegtest_HelloWorldActivity_getFFmpegInformation(JNIEnv *env,
                                                                                     jobject instance) {

    // TODO

    char *info = (char *) avcodec_configuration();
